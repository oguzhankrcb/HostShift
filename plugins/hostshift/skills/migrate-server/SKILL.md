...
- Preserve SSH, firewall, Fail2ban, Memcached, Logrotate, MySQL bind settings, Nginx/Apache/Caddy/PHP-FPM/Supervisor config, and application-level checks.
