...
func TestValidateRejectsUnsafeWorkloadMetadata(t *testing.T) {
	...
	tests := []Workload{
		...
		{Type: "memcached", Name: "memcached", Data: map[string]any{"service": "bad service"}},
		{Type: "memcached", Name: "memcached", Data: map[string]any{"config": "/etc"}},
		{Type: "rabbitmq", Name: "rabbitmq", Data: map[string]any{"service": "bad service"}},
		{Type: "rabbitmq", Name: "rabbitmq", Data: map[string]any{"configDir": "/etc"}},
		{Type: "rabbitmq", Name: "rabbitmq", Data: map[string]any{"configDir": "/srv/rabbitmq"}},
		{Type: "certbot", Name: "certbot", Data: map[string]any{"configDir": "/etc"}},
		{Type: "certbot", Name: "certbot", Data: map[string]any{"configDir": "/srv/letsencrypt"}},
